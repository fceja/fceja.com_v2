export const tagDataMap = new Map([
    ...
    ["bash", { name: "Bash", target: "_blank", url: "https://www.gnu.org/software/bash/" }],
    ...
    ["kafka", { name: "Apache Kafka", target: "_blank", url: "https://kafka.apache.org/" }],
    ...
    ["mocha", { name: "Mocha", target: "_blank", url: "https://mochajs.org/" }],
    ...
    ["sql", { name: "SQL", target: "_blank", url: "https://en.wikipedia.org/wiki/SQL" }],
